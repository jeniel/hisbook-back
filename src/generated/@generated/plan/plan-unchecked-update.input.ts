...
import { PlanFeatureUncheckedUpdateManyWithoutPlanNestedInput } from '../plan-feature/plan-feature-unchecked-update-many-without-plan-nested.input';
import { SubscriptionUncheckedUpdateManyWithoutPlanNestedInput } from '../subscription/subscription-unchecked-update-many-without-plan-nested.input';
...
export class PlanUncheckedUpdateInput {
    ...
    @Field(() => PlanFeatureUncheckedUpdateManyWithoutPlanNestedInput, {nullable:true})
    @Type(() => PlanFeatureUncheckedUpdateManyWithoutPlanNestedInput)
    features?: PlanFeatureUncheckedUpdateManyWithoutPlanNestedInput;

    @Field(() => SubscriptionUncheckedUpdateManyWithoutPlanNestedInput, {nullable:true})
    @Type(() => SubscriptionUncheckedUpdateManyWithoutPlanNestedInput)
