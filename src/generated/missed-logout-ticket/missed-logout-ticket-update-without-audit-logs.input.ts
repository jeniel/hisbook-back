...
@InputType()
export class MissedLogoutTicketUpdateWithoutAuditLogsInput {
    ...
    @Field(() => UserUpdateOneWithoutMissedLogoutTicketNestedInput, {nullable:true})
    createdBy?: UserUpdateOneWithoutMissedLogoutTicketNestedInput;
}
