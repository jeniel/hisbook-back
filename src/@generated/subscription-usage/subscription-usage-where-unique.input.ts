...
import { SubscriptionUsageSubscriptionIdFeatureIdPeriodCompoundUniqueInput } from './subscription-usage-subscription-id-feature-id-period-compound-unique.input';
...
@InputType()
export class SubscriptionUsageWhereUniqueInput {

    @Field(() => String, {nullable:true})
    id?: string;

    @Field(() => SubscriptionUsageSubscriptionIdFeatureIdPeriodCompoundUniqueInput, {nullable:true})
    subscriptionId_featureId_period?: SubscriptionUsageSubscriptionIdFeatureIdPeriodCompoundUniqueInput;
