...
import { CaseUpdateManyWithoutPatientNestedInput } from '../case/case-update-many-without-patient-nested.input';
...
export class PatientUpdateInput {
    ...
    @Field(() => CaseUpdateManyWithoutPatientNestedInput, {nullable:true})
    @Type(() => CaseUpdateManyWithoutPatientNestedInput)
    case?: CaseUpdateManyWithoutPatientNestedInput;
}
