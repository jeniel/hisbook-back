...
import { AgentTransactionOrderByWithAggregationInput } from './agent-transaction-order-by-with-aggregation.input';
import { AgentTransactionScalarFieldEnum } from './agent-transaction-scalar-field.enum';
import { AgentTransactionScalarWhereWithAggregatesInput } from './agent-transaction-scalar-where-with-aggregates.input';
...
@ArgsType()
export class AgentTransactionGroupByArgs {

    @Field(() => AgentTransactionWhereInput, {nullable:true})
    @Type(() => AgentTransactionWhereInput)
    where?: AgentTransactionWhereInput;

    @Field(() => [AgentTransactionOrderByWithAggregationInput], {nullable:true})
    orderBy?: Array<AgentTransactionOrderByWithAggregationInput>;

    @Field(() => [AgentTransactionScalarFieldEnum], {nullable:false})
    by!: Array<keyof typeof AgentTransactionScalarFieldEnum>;

    @Field(() => AgentTransactionScalarWhereWithAggregatesInput, {nullable:true})
    having?: AgentTransactionScalarWhereWithAggregatesInput;
