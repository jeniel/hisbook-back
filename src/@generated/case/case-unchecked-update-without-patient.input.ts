...
import { VitalSignUncheckedUpdateManyWithoutCaseNestedInput } from '../vital-sign/vital-sign-unchecked-update-many-without-case-nested.input';
import { Type } from 'class-transformer';

@InputType()
export class CaseUncheckedUpdateWithoutPatientInput {
    ...
    @Field(() => VitalSignUncheckedUpdateManyWithoutCaseNestedInput, {nullable:true})
    @Type(() => VitalSignUncheckedUpdateManyWithoutCaseNestedInput)
    vitalSign?: VitalSignUncheckedUpdateManyWithoutCaseNestedInput;
}
