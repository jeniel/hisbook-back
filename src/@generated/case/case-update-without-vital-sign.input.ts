...
import { PatientUpdateOneWithoutCaseNestedInput } from '../patient/patient-update-one-without-case-nested.input';

@InputType()
export class CaseUpdateWithoutVitalSignInput {
    ...
    @Field(() => PatientUpdateOneWithoutCaseNestedInput, {nullable:true})
    patient?: PatientUpdateOneWithoutCaseNestedInput;
}
