...
import { AgentTransactionUpdateManyWithoutProfileNestedInput } from '../agent-transaction/agent-transaction-update-many-without-profile-nested.input';
import { CommentUpdateManyWithoutProfileNestedInput } from '../comment/comment-update-many-without-profile-nested.input';

@InputType()
export class ProfileUpdateWithoutTicketTransactionInput {
    ...
    @Field(() => AgentTransactionUpdateManyWithoutProfileNestedInput, {nullable:true})
    agentTransaction?: AgentTransactionUpdateManyWithoutProfileNestedInput;
