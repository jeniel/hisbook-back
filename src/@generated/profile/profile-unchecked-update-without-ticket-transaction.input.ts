...
import { AgentTransactionUncheckedUpdateManyWithoutProfileNestedInput } from '../agent-transaction/agent-transaction-unchecked-update-many-without-profile-nested.input';
...
@InputType()
export class ProfileUncheckedUpdateWithoutTicketTransactionInput {
    ...
    @Field(() => AgentTransactionUncheckedUpdateManyWithoutProfileNestedInput, {nullable:true})
    agentTransaction?: AgentTransactionUncheckedUpdateManyWithoutProfileNestedInput;
