...
import { AgentTransactionCreateNestedManyWithoutProfileInput } from '../agent-transaction/agent-transaction-create-nested-many-without-profile.input';
import { CommentCreateNestedManyWithoutProfileInput } from '../comment/comment-create-nested-many-without-profile.input';

@InputType()
export class ProfileCreateWithoutTicketTransactionInput {
    ...
    @Field(() => AgentTransactionCreateNestedManyWithoutProfileInput, {nullable:true})
    agentTransaction?: AgentTransactionCreateNestedManyWithoutProfileInput;
