...
import { CaseUpdateOneWithoutVitalSignNestedInput } from '../case/case-update-one-without-vital-sign-nested.input';

@InputType()
export class VitalSignUpdateInput {
    ...
    @Field(() => CaseUpdateOneWithoutVitalSignNestedInput, {nullable:true})
    @Type(() => CaseUpdateOneWithoutVitalSignNestedInput)
    case?: CaseUpdateOneWithoutVitalSignNestedInput;
}
